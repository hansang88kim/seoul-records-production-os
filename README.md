...
**AI Music Label Production Harness — v0.4.1**
...
**v0.4.1: Local WAV import pipeline — no real Suno, Canva, YouTube, or UnitedMasters APIs. Manual WAV import → FFmpeg render → Distribution package.**
...
| v0.4.1 | SunoCliProvider docs, dry-run suno_cli support | ✅ Current |
