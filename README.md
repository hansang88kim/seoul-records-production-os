...
**AI Music Label Production Harness — v0.3.0**
...
**v0.3.0: Local WAV import pipeline — no real Suno, Canva, YouTube, or UnitedMasters APIs. Manual WAV import → FFmpeg render → Distribution package.**
...
| v0.3.0 | LocalUnofficialSunoProvider, provider capability system, Playwright skeleton | ✅ Current |
