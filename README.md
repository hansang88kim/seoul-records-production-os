...
**AI Music Label Production Harness — v0.4.0**
...
**v0.4.0: Local WAV import pipeline — no real Suno, Canva, YouTube, or UnitedMasters APIs. Manual WAV import → FFmpeg render → Distribution package.**
...
| v0.4.0 | SunoCliProvider (paperfoot/suno-cli subprocess adapter) | ✅ Current |
