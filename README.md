...
**AI Music Label Production Harness — v0.3.2**
...
**v0.3.2: Local WAV import pipeline — no real Suno, Canva, YouTube, or UnitedMasters APIs. Manual WAV import → FFmpeg render → Distribution package.**
...
| v0.3.2 | Suno one-song dry-run, endpoint mapping, credential safety | ✅ Current |
