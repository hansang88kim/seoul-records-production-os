...
**AI Music Label Production Harness — v0.3.1**
...
**v0.3.1: Local WAV import pipeline — no real Suno, Canva, YouTube, or UnitedMasters APIs. Manual WAV import → FFmpeg render → Distribution package.**
...
| v0.3.1 | Provider research matrix, pyproject.toml dependency fix | ✅ Current |
